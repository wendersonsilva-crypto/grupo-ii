...
**Persistência e notificações:** os dados devem ser armazenados e recuperados automaticamente ao carregar a página, em um local chamado "rascunho" fora do mural. Quando alguém demonstrar interesse, o autor do projeto deve receber uma notificação quando abrir a página (em qualquer dispósitivo) informando o nome da pessoa interessada e o título da ideia. Ao tocar ou clicar na notificação, o usuário deve ser direcionado para a ideia correspondente.
