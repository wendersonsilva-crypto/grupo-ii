...
Como usuário, quero poder buscar ideias por curso para procurar alunos que se interessem pelas mesmas coisas que eu, estando em determinado curso. Seria útil um filtro por curso na barra lateral do mural.
...
página tiver acesso às ideias que você se interessa, para te recomendar itens parecidos;
...
os dados forem para um tipo de rascunho em uma área específica, sem ser o mural.
...
V-10 — Ideias paradas — A estimar
V-11 — Relatório por curso — A estimar
V-12 — Exportar / importar o estado — 8 pontos
Defeitos conhecidos

Nenhum destes foi priorizado. Estão aqui para não serem esquecidos.

B-01 — Depois de clicar numa tag, não há como desfazer o filtro — 2 pontos

Só recarregando a página.

B-02 — Quando a busca não encontra nada — 2 pontos

O mural fica em branco, sem nenhuma explicação.

B-03 — Formato da data — 1 ponto

A data aparece como 2026-03-14 em vez de 14/03/2026.

B-04 — Busca sem acentos — 3 pontos

Buscar robotica não encontra "Robótica"; buscar Musica não encontra "música".

B-05 — Número de apoios no cartão — 3 pontos

Só muda depois que se refaz a busca.

B-06 — Título comprido — 2 pontos

Vaza para fora do cartão e atravessa o cartão vizinho.
