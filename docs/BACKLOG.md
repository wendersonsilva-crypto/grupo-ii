...
| **V-09**        | História escrita para avisar o autor quando alguém demonstrasse interesse. Fere a norma de que alunos não podem acessar o aparelho na escola.                                     | Foi alterado para que os alunos recebessem solicitações apenas quando acessassem a página, em qualquer dispositivo.                                         | A pontuação estima o esforço da funcionalidade. Porém, o trecho sobre caixa de entrada está incompleto e precisa ser esclarecido antes da implementação. |
